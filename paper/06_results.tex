...
\begin{threeparttable}
	...
	\begin{tabular}{clS[table-format=1.3]S[table-format=1.3] >{\sisetup{round-precision=4}}S[table-format=-1.4]}
		...
		& fx\_output\tnote{1} & 0.06125357 & 0.031521 & -0.004008 \\
		& fx\_csratio\tnote{2} & 0.06128621 & 0.032877 & 0.005391 \\
		& exog\tnote{3} & 0.06212085 & 0.035210 & 0.007142 \\
...
% NOTE: The solutions to the MPC problems are guaranteed to be reproducible and may vary somewhat from run to run and are dependent on the solver.
