...
\usepackage{eleco2013,amssymb,amsmath}
\usepackage{indentfirst}

\usepackage{caption}

\captionsetup[table]{labelfont=bf,labelformat=simple,labelsep=period}
\captionsetup[figure]{labelfont=bf,labelformat=simple,labelsep=period}

\setcounter{page}{1} \sloppy \ninept
